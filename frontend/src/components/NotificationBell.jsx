    ...
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-3 w-80 bg-white shadow-xl rounded-xl border z-50 max-h-96 overflow-y-auto">
          <div className="p-4 border-b font-semibold text-gray-800 sticky top-0 bg-white">
            Notifications
          </div>
              ...
              <div
                ...
                className={`p-4 border-b cursor-pointer transition-all duration-200 ${
                  item.isRead
                    ...
                    : "bg-blue-50 border-l-4 border-blue-500 shadow-sm hover:bg-blue-100"
                }`}
              >
                <p className={`text-sm ${item.isRead ? "text-gray-600" : "text-gray-900 font-semibold"}`}>
                  {item.message}
                </p>
